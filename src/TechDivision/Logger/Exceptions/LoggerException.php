...
/**
 * This is the exception that is thrown if an log
 * message can not be written to its destination.
 *
 * @package TechDivision_Logger
 ...
 * @license GPL
 */
class TechDivision_Logger_Exceptions_LoggerException extends Exception {
}