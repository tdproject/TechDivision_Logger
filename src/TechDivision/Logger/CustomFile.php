 ...
 * @license GPL
 */
class TechDivision_Logger_CustomFile extends TechDivision_Logger_Abstract {
	...
	public function __construct(
		...
		$this->logCustomFile = $this->getPropertyValue(
		    TechDivision_Logger_CustomFile::LOG_CUSTOM_FILE
		);
	}
	...
	public function log($message, $level = 3, $line = null, $method = null) {
		...
		if ($level <= $this->getLogLevel()) {
			...
			$written = error_log(
			    ...
			    TechDivision_Logger_CustomFile::LOG_TYPE_CUSTOM_FILE,
			    $this->logCustomFile
			);
